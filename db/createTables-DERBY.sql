...
create table dayenergypointvalue (
 id bigint not null generated by default as identity (start with 1, increment by 1),
  dataPointId int not null,
  dayValue double default null,
  ts bigint default null,
  xid varchar(10) default null
 -- PRIMARY KEY  (id)
) ;
alter table dayenergypointvalue add constraint dayenergypointvaluePk primary key (id);
...
alter table meter_item add constraint meter_itemPk primary key (id);
-- ----------------------------
-- Records
-- ----------------------------
...
alter table hourpowerpointvalue add constraint hourpowerpointvaluePk primary key (id);
...
alter table daypowerpointvalue add constraint daypowerpointvaluePk primary key (id);