 ...
 <div id="menu">
	...
	<div class="top_right">
		...
		<div class="top_right1">
			<ul>
				<li><a href="http://localhost:8080/"><img src="images/home.png" /><span>主页</span></a></li>
				<li><a href="logout.htm"><img src="/images/quit.png" /><span>退出</span></a></li>
			</ul>
		</div>
	</div>
    ...
    <div class="tit">  
        ...
        <ul>  
        <li><a href="computer_house_whole_view.shtm">&nbsp;&nbsp;&nbsp;&nbsp;温湿度</a></li>   
        </ul>  
    </div>  
    <div class="tit">  
        <span class="innerTit">能耗监控</span>  
        <ul>  
        <li><a href="hour_power_point_details.shtm">&nbsp;&nbsp;&nbsp;&nbsp;时能耗分析</a></li>  
        <li><a href="day_power_point_details.shtm" >&nbsp;&nbsp;&nbsp;&nbsp;日能耗分析</a></li> 
		<li><a href="month_power_bills_list.shtm" >&nbsp;&nbsp;&nbsp;&nbsp;电费清单</a></li> 	         
        </ul>  
    </div>      
    <div class="tit">  
